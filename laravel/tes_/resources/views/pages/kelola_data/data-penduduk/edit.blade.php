    ...
    <section class="content">
      ...
      @endif
            <div class="card card-info">
                ...
                <form action="{{ route('kelola_data-data_penduduk_update', $data->id) }}" method="POST" class="form-horizontal">
                    @method('PUT')
                    @csrf
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input 
                            type="number" 
                            class="form-control" 
                            placeholder="NIK (Harus 16 angka)"
                            name="nik"
                            value="{{ $data->nik }}"    
                        >
                      </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" name="gender">
                                ...
                                <option value="LK" {{ $data->gender == 'LK' ? 'selected' : '' }}>LK</option>
                                <option value="PR" {{ $data->gender == 'PR' ? 'selected' : '' }}>PR</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                  ...
                  <div class="card-footer text-right">
                    ...
                    <a href="{{ route('kelola_data-data_penduduk') }}" type="submit" class="btn btn-danger">Cancel</a>
                  </div>
                </form>
            </div>
        </div>
