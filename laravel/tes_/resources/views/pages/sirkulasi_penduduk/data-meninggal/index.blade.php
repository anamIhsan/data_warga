                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (Auth::user()->roles != 'WATCHER')
                                <a class="btn btn-primary btn-md mb-2" href="{{ route('sirkulasi_penduduk-data_meninggal_create') }}">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($dies as $data)
                                        <tr>
                                            ...
                                            @if (Auth::user()->roles != 'WATCHER')
                                                <td>
                                                    <a class="btn btn-success btn-sm" href="{{ route('sirkulasi_penduduk-data_meninggal_edit', $data->id) }}">
                                            ...
                                            <div id="deleteData-{{ $data->id }}" class="modal fade">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form class="d-inline-block" action="{{ route('sirkulasi_penduduk-data_meninggal_delete', $data->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
