    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-info">
                ...
                <form action="{{ route('sirkulasi_penduduk-data_pendatang_store') }}" method="POST" class="form-horizontal">
                @csrf
                @method('POST')
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <select name="pelapor" class="form-control select2" style="width: 100%;">
                                    <option selected="selected" disabled="disabled">-- Pilih Pelapor --</option>
                                    @foreach ($residents as $data)
