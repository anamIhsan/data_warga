                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (Auth::user()->roles != 'WATCHER')
                                <a class="btn btn-primary btn-md mb-2" href="{{ route('sirkulasi_penduduk-data_pindah_create') }}">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($moves as $data)
                                        <tr>
                                            ...
                                            @if (Auth::user()->roles != 'WATCHER')
                                                <td>
                                                    <a class="btn btn-success btn-sm" href="{{ route('sirkulasi_penduduk-data_pindah_edit', $data->id) }}">
                                            ...
                                            <div id="deleteData-{{ $data->id }}" class="modal fade">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form class="d-inline-block" action="{{ route('sirkulasi_penduduk-data_pindah_delete', $data->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')    
                                                            <div class="modal-header">						
                                                                <h4 class="modal-title">Delete Data Pindah</h4>
