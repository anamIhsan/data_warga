...
<div class="wrapper">
  ...
  <section class="invoice">
    <center>
      ...
      <table width="625">
        <tr>
          <td class="text2">SURAT KETERANGAN DOMISILI</td>
        </tr>
      </table>
      </table>
      <table>
      ...
      <table width="625">
        <tr>
             <td>
               <font size="2">Kpd yth.<br><strong>{{ $data->name }}</strong><br>Di tempat</font>
             </td>
          </tr>
      </table>
      <br>
      ...
      <table>
        <tr class="text2">
          <td>Alamat</td>
          <td width="541">: {{ $data->desa }} - RT.{{ $data->rt }} / RW.{{ $data->rw }}</td>
        </tr>
        <tr>
          <td>TTL</td>
          <td width="525">: {{ $data->tempat_lahir }}, {{ $data->tanggal_lahir }}</td>
        </tr>
        <tr>
          <td>Pekerjaan</td>
          <td width="525">: {{ $data->pekerjaan }}</td>
        </tr>
      </table>
      <br>
      <table width="625">
