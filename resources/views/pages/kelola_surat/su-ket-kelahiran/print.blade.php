...
<div class="wrapper">
  ...
  <section class="invoice">
    <center>
      ...
      <table width="625">
        <tr>
          <td class="text2">SURAT KETERANGAN KELAHIRAN</td>
        </tr>
      </table>
      </table>
      <table>
        <tr class="text2">
          <td>No KK</td>
          <td width="572">: {{ $data->familyCards_id }}</td>
        </tr>
        <tr>
          <td>Perihal</td>
      ...
      <table width="625">
        <tr>
             <td>
               <font size="2">Kpd yth.<br><strong>{{ $data->residents->name }}</strong><br>Di tempat</font>
             </td>
          </tr>
      </table>
      <br>
      ...
      <table>
        <tr class="text2">
          <td>Keluarga dari bapak</td>
          <td width="541">: {{ $data->familyCards_id }}</td>
        </tr>
        <tr>
          <td>TTL</td>
          <td width="525">: {{ $data->tanggal_lahir }}</td>
        </tr>
        <tr>
          <td>Jenis kelamin</td>
          <td width="525">: {{ $data->gender }}</td>
        </tr>
      </table>
      <br>
      <table width="625">
